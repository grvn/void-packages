...
export SHA256=$(curl --fail --location --retry 3 --retry-delay 2 --silent https://github.com/${REPO}/releases/download/v${VERSION}/river-status-v${VERSION}.tgz.sha256 | cut -d ' ' -f1 )
